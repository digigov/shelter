...
public class RNCropperModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  ...
  public void onCropperResult(final int resultCode, final Intent data) {
    ...
    if (resultCode == Activity.RESULT_OK) {
      ...
      Bitmap image = Bitmap.createScaledBitmap(original, width, height, true);
      ByteArrayOutputStream byteArray = new ByteArrayOutputStream();
      image.compress(Bitmap.CompressFormat.JPEG, 90, byteArray);
  ...
  public void showCropper(Uri sourceUri) {
    ...
    UCrop uCrop = UCrop
      .of(sourceUri, Uri.fromFile(getNewFile()))
  ...
  @ReactMethod
  public void getPhotoFromCamera(final ReadableMap params, final Promise promise) {
  ...
  @ReactMethod
  public void getPhotoFromAlbum(final ReadableMap params, final Promise promise) {
    activity = getCurrentActivity();
