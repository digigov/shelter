...
- (void)handleDeviceRegistered:(NSNotification *)notification
{
    ...
    #ifdef DEBUG
        [[FIRInstanceID instanceID] setAPNSToken:token type:FIRInstanceIDAPNSTokenTypeSandbox];
    #else
        [[FIRInstanceID instanceID] setAPNSToken:token type:FIRInstanceIDAPNSTokenTypeProd];
    #endif
