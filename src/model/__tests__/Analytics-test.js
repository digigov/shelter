...
describe('Analytics Model', () => {
  ...
  it('logScreen', () => {
    ...
    expect(Analytics.logEvent).lastCalledWith(LOG.VIEW_SCREEN, {
      item_id: name,
    });
  });
  ...
  it('logAppOpen', () => {
    ...
    AnalyticsModel.logAppOpen();
    expect(Analytics.logEvent).lastCalledWith(LOG.APP_OPEN);
  });
  ...
  it('logSearch', () => {
    ...
    expect(Analytics.logEvent).lastCalledWith(LOG.SEARCH, {
  ...
  it('logWishlist', () => {
    ...
    expect(Analytics.logEvent).lastCalledWith(LOG.ADD_TO_WISHLIST, {
  ...
  it('logCheckout', () => {
    ...
    expect(Analytics.logEvent).lastCalledWith(LOG.BEGIN_CHECKOUT, {
  ...
  it('logPurchase', () => {
    ...
    expect(Analytics.logEvent).lastCalledWith(LOG.ECOMMERCE_PURCHASE, {
      transaction_id: _.toString(id1),
      value: value1,
      currency: 'TWD',
      tax: 0,
  ...
  it('logRefund', () => {
    ...
    expect(Analytics.logEvent).lastCalledWith(LOG.PURCHASE_REFUND, {
